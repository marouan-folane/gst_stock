            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-end">{{ __('Phone Number (for SMS)') }}</label>
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">Enter phone number with country code (e.g., +1234567890) to receive SMS notifications</small>
                                @error('phone_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <form method="POST" action="{{ route('profile.notifications') }}">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="receive_sms" name="receive_sms" value="1" {{ !empty($user->phone_number) ? 'checked' : '' }}>
                                <label class="form-check-label" for="receive_sms">
                                    Receive SMS notifications for alerts
                                </label>
                                <div class="form-text">
                                    When enabled, you will receive SMS alerts for critical events like low stock and expiring products.
                                    Make sure your phone number is set in the profile section above.
                                </div>
                            </div>
                        </div>
